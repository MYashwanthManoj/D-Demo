...
export default function SignupForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="w-full">
      <h1 className="text-[24px] leading-[32px] font-semibold text-navy-900 mb-1">Create your free account</h1>
      <p className="text-[13px] leading-[20px] text-navy-500 mb-6">Everything you need for a first job, in one place.</p>
