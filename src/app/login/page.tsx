      ...
      <div className="hidden md:flex flex-col justify-between p-10 lg:p-14 w-[440px] bg-navy-900 shrink-0">
        ...
        <div>
          <div className="flex items-center gap-3 mb-6">
            <div className="w-11 h-11 rounded-lg bg-brand-700 flex items-center justify-center font-semibold text-[13px] text-brand-300">AK</div>
            <div>
              <p className="font-medium text-[14px] leading-[20px] text-white">Aditya Kulkarni</p>
              <p className="text-[12px] leading-[18px] text-brand-300">BCA 2025 · Frontend Developer</p>
            </div>
          </div>
          <p className="text-[17px] leading-[28px] text-brand-200 italic">&ldquo;The roadmap gave my last semester a shape. I stopped collecting random courses and finished one track properly.&rdquo;</p>
        </div>
        <div>
      ...
      <div className="flex-1 flex flex-col justify-center px-6 py-12 md:px-12 lg:px-20 bg-white">
        <div className="max-w-[400px] mx-auto w-full">
          ...
          <p className="text-center mt-6 text-[13px] leading-[20px] text-navy-500">
            New here? <Link href="/signup" className="text-brand-500 font-medium hover:underline">Create a free account</Link>
          </p>
        </div>
      </div>
    </div>
